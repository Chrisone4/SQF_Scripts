...
#define CRATE_CLASSNAME "CargoNet_01_box_F"
...
_supplies = _crate addAction["Get Supplies", "actions\echo\supplies\small_supplies.sqf"];

[_crate, true, [0, 2, 1], 0] remoteExec ["ace_dragging_fnc_setCarryable", 0, true];
[_crate, 5] call ace_cargo_fnc_setSize;
