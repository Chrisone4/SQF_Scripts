...
if (isNil "ASOT_fnc_ListOfRefuelTanks" || isNil "ASOT_fnc_refuelTanker") then {
	ASOT_fnc_ListOfRefuelTanks = {
		...
		
		{
			...
			_refuelTankerChild pushBack [[
				...
				{_this call ASOT_fnc_refuelTanker},
				{true},
				{},
